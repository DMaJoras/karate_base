...
- **Si la entrada es un comando cURL:** Se generarán automáticamente al menos 4 escenarios base:
...
| Tags principales    | @REQ_ID @descripcion @default   | @REQ_BTPMCDP-118 @account_creation  @Agente2 @E2 @iniciativa_Marvel |
| Tags escenario      | @id:N @descripcion @resultado   | @id:1 @crearPersonaje @solicitudExitosa200 |
| Escenarios          | T-API-ID-CAN-Descripción        | CA01-Crear cuenta exitosamente 201 - karate |
